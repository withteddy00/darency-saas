...
export default function ResidentDocumentsPage({ params }: PageProps) {
  ...
  const t = {
    fr: {
      title: 'Documents',
      description: 'Documents de la résidence',
      emptyTitle: 'Aucun document',
      emptyDescription: 'Les documents apparaîtront ici',
    },
    ar: {
      title: 'المستندات',
      description: 'مستندات العقار',
      emptyTitle: 'لا توجد مستندات',
      emptyDescription: 'ستظهر المستندات هنا',
    }
  }
