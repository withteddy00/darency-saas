...
export default function AnnouncementsPage({ params }: PageProps) {
  ...
  const t = {
    fr: {
      title: 'Annonces',
      description: 'Publiez des annonces pour les résidents',
      emptyTitle: 'Aucune annonce',
      emptyDescription: 'Les annonces apparaîtront ici une fois publiées',
      createAnnouncement: 'Créer une annonce',
    },
    ar: {
      title: 'الإعلانات',
      description: 'انشر إعلانات للمقيمين',
      emptyTitle: 'لا توجد إعلانات',
      emptyDescription: 'ستظهر الإعلانات هنا بمجرد نشرها',
