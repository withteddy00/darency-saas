...
export default function ResidentChargesPage({ params }: PageProps) {
  ...
  const t = {
    fr: {
      title: 'Mes charges',
      description: ' Consultez vos charges mensuelles',
      emptyTitle: 'Aucune charge',
      emptyDescription: 'Vos charges mensuelles apparaîtront ici',
    },
    ar: {
      title: 'رسومي',
      description: 'عرض الرسوم الشهرية',
      emptyTitle: 'لا توجد رسوم',
      emptyDescription: 'ستظهر الرسوم الشهرية هنا',
    }
  }
